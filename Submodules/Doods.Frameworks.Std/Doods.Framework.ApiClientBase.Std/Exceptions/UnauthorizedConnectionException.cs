...
namespace Doods.Framework.ApiClientBase.Std.Exceptions
{
        ...
        : Exception
    {
        ...
        ///     The <see cref="T:System.Net.Http.HttpStatusCode" /> that was received while authenticating
        ///     against the YouTrack server.
        /// </param>
        ...
        /// <summary>
        ///     The <see cref="T:System.Net.Http.HttpStatusCode" /> that was received while authenticating against the YouTrack
        ///     server.
        /// </summary>
