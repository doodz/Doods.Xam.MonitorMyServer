...
namespace Doods.Synology.Webapi.Std.NewFolder
{
    public class SystemInfo
    {
        ...
        public long CpuClockSpeed { get; set; }
        ...
        public bool EnabledNtp { get; set; }
        ...
        [JsonProperty("sata_dev")]
        public List<object> SataDev { get; set; }

        [JsonProperty("serial")]
        public string Serial { get; set; }

        [JsonProperty("support_esata")]
        public string SupportEsata { get; set; }

        [JsonProperty("sys_temp")]
        public long SysTemp { get; set; }
        ...
        public List<object> UsbDev { get; set; }
    }
}