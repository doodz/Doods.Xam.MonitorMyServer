...
{
    [TestClass]
    public class SynologyCgiServiceUnitTest : PackageUpdatesUnitTest
    {
        ...
        public static void ClassInitialize(TestContext ctx)
        {
            ...
            _service = new SynologyCgiService(loggerMock.Object, connectionMock.Object, mapperMock.Object);
        ...
        public void Create()
        {
            ...
            connectionMock.Setup(connection => connection.ConnectionType).Returns(ConnectionType.Http);
            connectionMock.Setup(connection => connection.Credentials).Returns(new Credentials());
            var obj = new SynologyCgiService(loggerMock.Object, connectionMock.Object, mapperMock.Object);
            Assert.IsInstanceOfType(obj, typeof(ISynologyCgiService));
