...
namespace Doods.Openmediavault.Rpc.Std.Data.V4
{
    public class Date
    {
        [JsonProperty("local")] public string Local { get; set; }

        [JsonProperty("ISO8601")] public DateTimeOffset Iso8601 { get; set; }
    }
    ...
    public class Plugin
    {
        ...
        [JsonProperty("pluginsection")] public string Pluginsection { get; set; }
